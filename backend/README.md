...
## Project Structure
    ...
    ├── test_pendo_studio_l_37983  # Django project configurations
...
1. Clone this repo and `cd test_pendo_studio_l_37983`
...
2. Clone this repo and `cd test_pendo_studio_l_37983`
